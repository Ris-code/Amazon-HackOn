...
def retrieve_tool2(index, topic, description):
    # Initialize Pinecone client
    pc_client = pc(api_key=os.environ.get("PINECONE_API_KEY_ASHU"))
    Index = pc_client.Index(index)
...
## Tool 4 
retrieve_tool_4 = retrieve_tool2("prime-members" , 
                                topic= "Prime-Members",
...
tool = [retrieve_tool_1, retrieve_tool_2, retrieve_tool_3, retrieve_tool_4 , order_confirmation, financial_management]